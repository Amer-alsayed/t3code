  ...
  return (
    <SidebarInset className="h-dvh min-h-0 overflow-hidden overscroll-y-none bg-background text-foreground isolate">
      <div className="flex min-h-0 min-w-0 flex-1 flex-col bg-background text-foreground">
        {isElectron && (
          <div className="drag-region flex h-[36px] shrink-0 items-center gap-2 border-b border-border px-3">
        ...
        <div className="flex-1 overflow-y-auto p-6" style={{ animation: "var(--animate-fluid-fade-in)" }}>
